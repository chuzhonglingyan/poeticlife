$(function () {
    $('#content-main').css('height', $('body').height() + 'px');
    ...
    $('.bars-toggle, .logo-element').on('click', function () {
        $("body").toggleClass("mini-navbar");
        SmoothlyMenu();
        $('.J_iframe').css('width', '100%');
    });
    ...
    function n() {
        ...
        if ($(".J_menuTab").each(function () {
            ...
            var s = '<a href="javascript:;" class="active J_menuTab" data-index="'+a+'" data-id="' + t + '">' + i + ' <i class="fa fa-refresh" style="margin-right: 5px;margin-left: 5px;"></i>'
            s += "<i class='fa fa-times-circle' onclick='delMenu(\""+t+"\")'></i></a>";
    ...
    function s() {
        ...
        if($(this).hasClass("fa-times-circle")) { //关闭
        ...
        } else if($(this).hasClass("fa-refresh")) { // 刷新
            $('.J_iframe[data-id="'+ $(this).parent().data("id") +'"]').attr('src', $(this).parent().data("id"));
        }
        return !1
    }
