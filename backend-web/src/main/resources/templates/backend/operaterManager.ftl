...
<div id="operaterList">
            ...
            <div class="modal-content animated bounceInRight">
                ...
                <small>
                    <div class="modal-body">
                        <form class="form-horizontal " id="addUserForm">
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="accountName" name="accountName" minlength="2"
                            ...
                            <div class="form-group" id="passWordForm">
                                ...
                                <div class="col-sm-8">
                                    <input id="passWord" name="passWord" minlength="2"
                                           maxlength="20" type="password" placeholder="默认密码123456"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="userName" name="userName" minlength="2"
                                           maxlength="50" type="text" class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="email" name="email" type="email" maxlength="30"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" @click="saveUser()">保存
                        </button>
                    </div>
    ...
    <div class="modal inmodal" id="editorRoleModal" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content animated bounceInRight">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal">
                ...
                <small>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-white" data-dismiss="modal">关闭</button>
                        <button type="button" class="btn btn-primary" @click="saveEditorRole()">保存
                        </button>
                    </div>
                </small>
            </div>
