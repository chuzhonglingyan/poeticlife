...
import com.yuntian.poeticlife.config.shiro.KickoutSessionControlFilter;
import com.yuntian.poeticlife.config.shiro.RedisCacheManager;
import com.yuntian.poeticlife.config.shiro.RedisManager;
...
import com.yuntian.poeticlife.config.shiro.ShiroLogoutFilter;
import com.yuntian.poeticlife.config.shiro.ShiroRealm;
import com.yuntian.poeticlife.config.shiro.ShiroSessionFactory;
import com.yuntian.poeticlife.config.shiro.ShiroSessionListener;
import com.yuntian.poeticlife.config.shiro.ShiroSessionManager;
...
//        shiroRealm.setCredentialsMatcher(retryLimitHashedCredentialsMatcher());
    ...
    public FormAuthenticationFilter formAuthenticationFilter() {
        ...
        formAuthenticationFilter.setRememberMeParam(CookieRememberMeManager.DEFAULT_REMEMBER_ME_COOKIE_NAME);
    ...
    public RedisCacheManager shrioRedisCacheManager() {
        ...
        redisCacheManager.setKeyPrefix(shiroProperties.getCachePrefix());
        //用户权限信息缓存时间
        redisCacheManager.setExpire(shiroProperties.getCacheExpireIn());
    ...
    public SessionManager sessionManager() {
        ...
        sessionManager.setCacheManager(shrioRedisCacheManager());
