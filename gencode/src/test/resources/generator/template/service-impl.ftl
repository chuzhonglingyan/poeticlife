...
public class ${modelNameUpperCamel}ServiceImpl extends AbstractService<${modelNameUpperCamel}DTO,${modelNameUpperCamel}> implements ${modelNameUpperCamel}Service {
    ...
    @Override
    public PageInfoVo<${modelNameUpperCamel}> queryListByPage(${modelNameUpperCamel}DTO dto) {
        ...
        List<${modelNameUpperCamel}> list = findByCondition(condition);
        return new PageInfoVo<>(new PageInfo<>(list));
    }

    @Override
    public void saveByDTO(${modelNameUpperCamel} dto) {
        AssertUtil.isNotNull(dto, "参数不能为空");
        save(dto);
    }

    @Override
    public void updateByDTO(${modelNameUpperCamel} dto) {
        AssertUtil.isNotNull(dto, "参数不能为空");
    ...
    @Override
    public void deleteByDTO(${modelNameUpperCamel} dto) {
        AssertUtil.isNotNull(dto, "参数不能为空");
        AssertUtil.isNotNull(dto.getId(),"${modelNameDesc}id不能为空");
